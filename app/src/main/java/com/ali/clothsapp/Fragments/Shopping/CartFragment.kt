...
import com.ali.clothsapp.Adapters.CartProductAdapter
import com.ali.clothsapp.databinding.FragmentCartBinding
import com.ali.clothsapp.Firebase.FirebaseCommon
            ...
            viewModel.deleteDialog.collectLatest {
                val alertDialog = AlertDialog.Builder(requireContext()).apply {
                    ...
                    setPositiveButton("Yes") { dialog, _ ->
                        ...
                        dialog.dismiss()
                        Toast.makeText(requireContext(), "Item removed from cart", Toast.LENGTH_SHORT).show() //gpt
                    }
                }
                alertDialog.create().show() //gpt
            }
        }
